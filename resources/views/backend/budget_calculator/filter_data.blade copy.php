                    ...
                    <div class="card shadow-md border-0 mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="h2 font-weight-bold text-success mb-0">TK {{ $totalCost ? $totalCost : '00' }}
                                </p>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="h4 font-weight-bold mb-0">
                                        {{ ceil(\Carbon\Carbon::parse($budgetEstimate->start_date)->diffInDays($budgetEstimate->end_date) / 7) }}
                                    </p>
                                </div>
                            </div>
